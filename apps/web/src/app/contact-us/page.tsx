...
export default function ContactUsPage() {
  return (
    <div>
      ...
      <h1 style={{ fontSize: 'clamp(1.9rem, 4vw, 2.75rem)', lineHeight: 1.1, margin: '0 0 2.5rem', fontWeight: 700 }}>
        Contact us, <span style={{ color: 'var(--highlight)' }}>we love to hear from you</span>
      </h1>
